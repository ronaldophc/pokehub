...
<section class="space-y-5">
    <div>
        <h3 class="text-base font-semibold text-zinc-800">{{ __('Update Password') }}</h3>
        <p class="text-sm text-zinc-400 mt-0.5">{{ __('Ensure your account is using a long, random password to stay secure.') }}</p>
    </div>
